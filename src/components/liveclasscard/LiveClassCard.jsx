      ...
      {isAuth ? (
        <>
          ...
          {user && user.role === "user" && (
            <>
              {liveClass.purchased ? (
                <button onClick={() => handleJoinClass(liveClass._id)} className="common-btn" disabled={isExpired}>
                  Join Class
                </button>
              ) : liveClass.purchasedByAnyUser && !liveClass.purchased ? (
                <button
                ...
                <button onClick={() => handleGetStarted(liveClass._id)} className="common-btn" disabled={isExpired}>
                  Get Started
                </button>
              )}
            </>
